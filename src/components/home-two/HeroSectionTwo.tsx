          ...
          <div className="row align-items-center">
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div className="hero__content hero__content-2 p-relative z-index-1">
                ...
                <h5>🎓 Lifetime Tech Support & 20+ Computer, IT & AI Courses</h5>
                <p>💥 Courses starting from just ₹499/month (Limited Time Offer)</p>
                ...
                <div className="hero__search">
                  ...
                  <p>
                  No matter your background, your ideal course starts here.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="hero__thumb-2 scene">
                  ...
                  >
                      ...
                      <span className="cap">
                        <svg viewBox="0 0 791.8 791.8">
                          <g>
                            <path
                              className="st0"
                              d="M395.9,501l-236.2-72.7v71.5v49.9c0,56.1,105.8,101.6,236.3,101.6s236.3-45.5,236.3-101.6c0-0.4-0.1-0.9-0.2-1.3V428.3L395.9,501z"
                            />
                            <path
                              className="st0"
                              d="M0,318.7l84.4,30.2l7.2-15.4l31-2.6l4.4,4.6l-26.6,6.3l-3.9,11.5c0,0-60.1,125.6-51.3,187c0,0,37.5,22.4,75,0l10-168v-14l55.8-12.6l-3.9,9.7L140.5,369l19.2,6.9l236.2,72.7l236.2-72.7l159.7-57.1L395.9,166.4L0,318.7z"
                            />
                          </g>
                        </svg>
                      </span>
                    ...
                    <div className="hero__promotion-text">
                      ...
                      <p>Assisted Student by Yugesh sir</p>
                    </div>
                  </div>
                  <div
                      ...
                      <svg viewBox="0 0 512 512">
                        <g>
                          <g>
                            <path
                              className="st0"
                              d="M435.7,0H126.5C89.6,0,59.6,30,59.6,66.9v378.3c0,36.9,30,66.9,66.9,66.9h309.2c9.2,0,16.7-7.5,16.7-16.7c0-17.5,0-461.2,0-478.6C452.4,7.5,444.9,0,435.7,0z M338.9,396.2c0,13.7-15.7,21.5-26.6,13.4L244,358.9h-54.2c-9.2,0-16.7-7.5-16.7-16.7v-72c0-9.2,7.5-16.7,16.7-16.7H244l68.3-50.7c11-8.2,26.6-0.3,26.6,13.4V396.2z M419,100.3H126.5c-18.5,0-33.5-15-33.5-33.5c0-18.5,15-33.5,33.5-33.5H419V100.3z"
                            />
                          </g>
                        </g>
                        <g>
